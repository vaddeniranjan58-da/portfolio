...
select subscription_status, count(customer_id),
		round(avg(purchase_amount),2) as avg_pa,
        round(sum(purchase_amount),2) as sum_pa
from customer
group by subscription_status
order by sum_pa,avg_pa;
...
select customer_segment,count(*) as num_of_customers from customer_type
